...
public final class CameraManager {
    ...
    private static int MIN_FRAME_WIDTH = 225;
    private static int MIN_FRAME_HEIGHT = 225;
    private static int MAX_FRAME_WIDTH = 225;
    private static int MAX_FRAME_HEIGHT = 225;
    ...
    public Rect getFramingRect() {
        ...
        if (framingRect == null) {
            ...
            int topOffset = (screenResolution.y - height) / 2 - dip2px(80);
