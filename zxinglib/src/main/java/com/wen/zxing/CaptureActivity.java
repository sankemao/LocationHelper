...
public class CaptureActivity extends AppCompatActivity implements Callback {
    ...
    public static OnScanListener mOnScanListener;
    TextView tx_cancel_scan;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tx_cancel_scan = (TextView) findViewById(R.id.tx_cancel_scan);
        hasSurface = false;
    ...
    public void laterInit() {
        ...
        tx_cancel_scan.setOnClickListener(new View.OnClickListener() {
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (TextUtils.isEmpty(resultString)) {
            ...
            if (mOnScanListener != null) {
                mOnScanListener.onScanSucceed(resultString, barcode);
            }
        }
            ...
            switch (msg.what) {
                case 1:
                    ...
                    if (resultString.equals("")) {
                        ...
                        if (mOnScanListener != null) {
                            mOnScanListener.onScanSucceed(resultString, null);
                        }
                    }
                    CaptureActivity.this.finish();
                    break;
