package com.pronetway.locationhelper.db.dbutils;

import android.content.Context;

import com.pronetway.locationhelper.app.MyApplication;
import com.pronetway.locationhelper.bean.LocationInfo;
import com.pronetway.locationhelper.db.gen.DaoSession;
import com.pronetway.locationhelper.db.gen.LocationInfoDao;
...
public class LocationDbUtils {
    ...
    //单例
    private static LocationDbUtils mLocationDbUtils = new LocationDbUtils(MyApplication.cxt);
    ...
    public void wipeData() {
        LocationInfoDao.dropTable(GreenDaoHelper.getDatabase(MyApplication.cxt), true);
        LocationInfoDao.createTable(GreenDaoHelper.getDatabase(MyApplication.cxt), true);
    }
}
